...
| C10.2 | deferred | [V1 CLI](../../spec/05-tooling.md#v1-cli) | `lint`, `build`, `query`, `edit`, `mcp`, and dependency mutation are valid v1 names but unavailable in M2 | Step 12 availability cases |
