...
> **Status:** Historical working plan. Its YAML-era implementation assumptions
> are retained for provenance; consult the accepted contracts in
> [`../decisions/`](../decisions/) before reusing any step.
...
**Files:**
- Modify: `README.md`
- Consult: `docs/decisions/s-expression-language.md` and archive historical YAML notes in `docs/archive/yaml-surface-draft.md`
